...
type GetPreviousPageParamFunction<TPageParam, TQueryFnData = unknown> = (firstPage: TQueryFnData, allPages: TQueryFnData[], firstPageParam: TPageParam, allPageParams: TPageParam[]) => TPageParam | undefined | null;
type GetNextPageParamFunction<TPageParam, TQueryFnData = unknown> = (lastPage: TQueryFnData, allPages: TQueryFnData[], lastPageParam: TPageParam, allPageParams: TPageParam[]) => TPageParam | undefined | null;
...
type FetchInfiniteQueryOptions<TQueryFnData = unknown, TError = DefaultError, TData = TQueryFnData, TQueryKey extends QueryKey = QueryKey, TPageParam = unknown> = FetchQueryOptions<TQueryFnData, TError, InfiniteData<TData, TPageParam>, TQueryKey, TPageParam> & DefaultPageParam<TPageParam> & FetchInfiniteQueryPages<TQueryFnData, TPageParam>;
...
export { FetchPreviousPageOptions as $, DefaultPageParam as A, InfiniteQueryPageParamsOptions as B, CancelledError as C, DefaultError as D, QueryObserverOptions as E, DefaultedQueryObserverOptions as F, GetPreviousPageParamFunction as G, InfiniteQueryObserverOptions as H, InitialDataFunction as I, DefaultedInfiniteQueryObserverOptions as J, FetchQueryOptions as K, FetchInfiniteQueryOptions as L, MutationCache as M, NetworkMode as N, ResultOptions as O, PlaceholderDataFunction as P, QueryCache as Q, Register as R, RefetchOptions as S, ThrowOnError as T, Updater as U, InvalidateQueryFilters as V, WithRequired as W, RefetchQueryFilters as X, InvalidateOptions as Y, ResetOptions as Z, FetchNextPageOptions as _, QueryCacheNotifyEvent as a, FetchContext as a$, QueryStatus as a0, FetchStatus as a1, QueryObserverBaseResult as a2, QueryObserverLoadingResult as a3, QueryObserverLoadingErrorResult as a4, QueryObserverRefetchErrorResult as a5, QueryObserverSuccessResult as a6, DefinedQueryObserverResult as a7, QueryObserverResult as a8, InfiniteQueryObserverBaseResult as a9, QueryBehavior as aA, ObserverFetchOptions as aB, NotifyOptions as aC, DataUpdateFunction as aD, QueryTypeFilter as aE, noop as aF, functionalUpdate as aG, isValidTimeout as aH, timeUntilStale as aI, matchMutation as aJ, hashQueryKeyByOptions as aK, partialMatchKey as aL, shallowEqualObjects as aM, isPlainArray as aN, isPlainObject as aO, sleep as aP, scheduleMicrotask as aQ, replaceData as aR, addToEnd as aS, addToStart as aT, Action$1 as aU, getDefaultState as aV, Retryer as aW, RetryValue as aX, RetryDelayValue as aY, canFetch as aZ, createRetryer as a_, InfiniteQueryObserverLoadingResult as aa, InfiniteQueryObserverLoadingErrorResult as ab, InfiniteQueryObserverRefetchErrorResult as ac, InfiniteQueryObserverSuccessResult as ad, DefinedInfiniteQueryObserverResult as ae, InfiniteQueryObserverResult as af, MutationKey as ag, MutationStatus as ah, MutationMeta as ai, MutationFunction as aj, MutationOptions as ak, MutationObserverOptions as al, MutateOptions as am, MutateFunction as an, MutationObserverBaseResult as ao, MutationObserverIdleResult as ap, MutationObserverLoadingResult as aq, MutationObserverErrorResult as ar, MutationObserverSuccessResult as as, MutationObserverResult as at, QueryClientConfig as au, DefaultOptions as av, CancelOptions as aw, SetDataOptions as ax, NotifyEventType as ay, NotifyEvent as az, QueryClient as b, FetchDirection as b0, FetchMeta as b1, FetchOptions as b2, Action as b3, SetStateOptions as b4, QueryStore as b5, QueryObserver as c, MutationObserver as d, MutationFilters as e, QueryFilters as f, isCancelledError as g, hashKey as h, isServer as i, Query as j, keepPreviousData as k, QueryState as l, matchQuery as m, Mutation as n, MutationState as o, QueryKey as p, QueryFunction as q, replaceEqualDeep as r, QueryFunctionContext as s, QueriesPlaceholderDataFunction as t, QueryKeyHashFunction as u, GetNextPageParamFunction as v, InfiniteData as w, QueryMeta as x, NotifyOnChangeProps as y, QueryOptions as z };
